 ...
 * Compiled Thu, 23 Feb 2023 16:03:30 UTC
 *
    ...
    HTMLAudioInstance.prototype.play = function (options) {
        ...
        this._source.onloadedmetadata = function () {
            if (_this._source) {
                ...
                Ticker.shared.add(_this._onUpdate, _this);
            }
        };
...
function render(sound, options) {
    ...
    var baseTexture = BaseTexture.from(canvas);
...
export { Filter, Filterable, Sound, SoundLibrary, SoundLoader, SoundSprite, index$2 as filters, index$3 as htmlaudio, sound, index as utils, index$1 as webaudio };
